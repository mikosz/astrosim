...
struct Unit final
{
	...
	static constexpr auto IS_CONVERTIBLE_TO =
		M_EXP == OtherUnitT::M_EXP && KG_EXP == OtherUnitT::KG_EXP && S_EXP == OtherUnitT::S_EXP;

	template <class OtherUnitT>
	using ConversionRatio = std::ratio_multiply<
	...
	{
		static_assert(IS_CONVERTIBLE_TO<CompatibleUnitT>);
		using Ratio = ConversionRatio<CompatibleUnitT>;
...
using Dimensionless = Private::Unit<std::ratio<1>, 0, std::ratio<1>, 0, std::ratio<1>, 0>;
...
using DistanceUnit = Private::Unit<ToMRatio, 1, std::ratio<1>, 0, std::ratio<1>, 0>;

template <class ToKgRatio>
using MassUnit = Private::Unit<std::ratio<1>, 0, ToKgRatio, 1, std::ratio<1>, 0>;

template <class ToSRatio>
using TimeUnit = Private::Unit<std::ratio<1>, 0, std::ratio<1>, 0, ToSRatio, 1>;
...
public:
	...
	template <class CompatibleUnitT>
	constexpr Value(CompatibleUnitT unit, float value) : value_(unit.template convertTo<Unit>(value))
	{
	}

	template <class CompatibleUnitT>
	constexpr Value(Value<CompatibleUnitT> compatibleValue) : value_(compatibleValue.template value<Unit>())
	{
	}
...
constexpr Value<UnitT> makeValue(float value)
{
...
constexpr Value<Metres> operator""_m(long double value)
{
	return Value<Metres>{Metres{}, static_cast<float>(value)};
}

constexpr Value<Metres> operator""_m(unsigned long long value)
{
	return Value<Metres>{Metres{}, static_cast<float>(value)};
}

constexpr Value<Metres> operator""_km(long double value)
{
	return Value<Kilometres>{Kilometres{}, static_cast<float>(value)};
}

constexpr Value<Kilometres> operator""_km(unsigned long long value)
{
	return Value<Kilometres>{Kilometres{}, static_cast<float>(value)};
}

constexpr Value<Kilograms> operator""_kg(long double value)
{
	return Value<Kilograms>{Kilograms{}, static_cast<float>(value)};
}

constexpr Value<Kilograms> operator""_kg(unsigned long long value)
{
	return Value<Kilograms>{Kilograms{}, static_cast<float>(value)};
}

constexpr Value<Grams> operator""_g(long double value)
{
	return Value<Grams>{Grams{}, static_cast<float>(value)};
}

constexpr Value<Grams> operator""_g(unsigned long long value)
{
	return Value<Grams>{Grams{}, static_cast<float>(value)};
}

constexpr Value<Milliseconds> operator""_ms(long double value)
{
	return Value<Milliseconds>{Milliseconds{}, static_cast<float>(value)};
}

constexpr Value<Milliseconds> operator""_ms(unsigned long long value)
{
	return Value<Milliseconds>{Milliseconds{}, static_cast<float>(value)};
}

constexpr Value<Seconds> operator""_s(long double value)
{
	return Value<Seconds>{Seconds{}, static_cast<float>(value)};
}

constexpr Value<Seconds> operator""_s(unsigned long long value)
{
	return Value<Seconds>{Seconds{}, static_cast<float>(value)};
}

constexpr Value<Minutes> operator""_min(long double value)
{
	return Value<Minutes>{Minutes{}, static_cast<float>(value)};
}

constexpr Value<Minutes> operator""_min(unsigned long long value)
{
	return Value<Minutes>{Minutes{}, static_cast<float>(value)};
}

constexpr Value<Hours> operator""_h(long double value)
{
	return Value<Hours>{Hours{}, static_cast<float>(value)};
}

constexpr Value<Hours> operator""_h(unsigned long long value)
{
	return Value<Hours>{Hours{}, static_cast<float>(value)};
}

constexpr Value<MPS> operator""_mps(long double value)
{
	return Value<MPS>{MPS{}, static_cast<float>(value)};
}

constexpr Value<MPS> operator""_mps(unsigned long long value)
{
	return Value<MPS>{MPS{}, static_cast<float>(value)};
}

constexpr Value<KPH> operator""_kph(long double value)
{
	return Value<KPH>{KPH{}, static_cast<float>(value)};
}

constexpr Value<KPH> operator""_kph(unsigned long long value)
{
	return Value<KPH>{KPH{}, static_cast<float>(value)};
}

constexpr Value<MPS2> operator""_mps2(long double value)
{
	return Value<MPS2>{MPS2{}, static_cast<float>(value)};
}

constexpr Value<MPS2> operator""_mps2(unsigned long long value)
{
	return Value<MPS2>{MPS2{}, static_cast<float>(value)};
}

constexpr Value<Newtons> operator""_N(long double value)
{
	return Value<Newtons>{Newtons{}, static_cast<float>(value)};
}

constexpr Value<Newtons> operator""_N(unsigned long long value)
{
	return Value<Newtons>{Newtons{}, static_cast<float>(value)};
}
